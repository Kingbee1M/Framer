...
export default function Everything () {
    ...
    return (
        <div className="w-full h-auto flex flex-col justify-center items-center gap-1 font-main mt-20">
            ...
            <div className="font-head text-[22px] font-[800] text-center md:text-[30px]">Streamlined for <p className="text-lightBlue">easy management</p></div>
            ...
            <div className="w-full flex flex-col justify-center items-center mt-20 gap-10 lg:flex-row">
