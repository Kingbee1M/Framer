...
export default function Everything () {
    ...
    return (
        <div className="w-full h-auto flex flex-col justify-center items-center gap-1 font-main mt-20">
            ...
            <div className="purpleFont break-words text-center text-[15px] text-purpleFont">Enjoy customizable lists, team work tools, and smart tracking all in one place. Set tasks, get reminders, and see your progress simply and quickly.</div>
